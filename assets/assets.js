...
export const SkillsInfo = [
  {
    title: "Languages",
    skills: [
      { name: "Python", logo: skill_icons.Python, },
      { name: "JavaScript", logo: skill_icons.JavaScript },
      { name: "TypeScript", logo: skill_icons.TypeScript },
    ],
  },
  {
    title: "Frontend",
    skills: [
      { name: "HTML", logo: skill_icons.HTML },
      { name: "CSS", logo: skill_icons.CSS },
      { name: "React JS", logo: skill_icons.ReactJS },
      { name: "Next JS", logo: skill_icons.NextJS },
  ...
  },
  {
    title: "Backend",
    skills: [
      { name: "Node Js", logo: skill_icons.NodeJs },
      { name: "Express Js", logo: skill_icons.ExpressJs },
      { name: "Django", logo: djangoLogo },
      { name: "MongoDB", logo: mongodb },
      { name: "MySQL", logo: mysql },
      { name: "PostgreSQL", logo: skill_icons.PostgreSQL },
    ],
  },
  {
    title: "Tools",
    skills: [
      { name: "Git", logo: skill_icons.Git },
      { name: "GitHub", logo: skill_icons.GitHub },
...
export const education = [
  {
    ...
    grade: "7.3 CGPA",
    desc: "I completed my Bachelor's degree in Computer Science and Engineering (B.Tech) from Trident Academy of Technology, Bhubaneswar, Odisha. Throughout my studies, I developed a strong foundation in programming, Data Structures and Algorithms, Web Development, Database Management Systems, and software engineering.",
    degree: "Bachelor of Technology - B.Tech",
  },

  {
    id: 1,
    school: "Your Higher Secondary School, Odisha",
    date: "2020 - 2021",
    grade: "Your Grade / Percentage",
    desc: "I completed my Higher Secondary education with a focus on building a strong foundation in core academic subjects. This stage helped me develop analytical thinking, problem-solving skills, and an interest in computer science and technology.",
    degree: "Higher Secondary Education - +2",
  },

  {
    id: 2,
    school: "Your Matriculation School, Odisha",
    date: "2018 - 2019",
    grade: "Your Grade / Percentage",
    desc: "I completed my Matriculation education, developing a strong academic foundation and essential skills in mathematics, science, communication, and problem-solving.",
